...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        ...
        forgescript_1.Arg.optionalBoolean("preserveApostrophe", "Preserve apostrophes in contractions (default: false)"),
    ...
    execute(ctx, [text, preserveApostrophe, variable]) {
        try {
            const tokens = tokenizer_1.Tokenizer.Case(text, { preserveApostrophe: preserveApostrophe ?? false });
            if (!variable)
...
//# sourceMappingURL=caseTokenize.js.map